class Ini:
    ...
    def get(self, log: str, ini: str, section: str, param: str):
        ...
        try:
            ...
            with open(log, 'a') as log_file:
                log_file.write(f'{self.now.date(), self.now.time()}: ini get param error: {str(Argument)}\n')
        else:
    ...
    def set(self, log: str, ini: str, section: str, param: str, data: str):
        ...
        try:
            ...
            with open(log, 'a') as log_file:
                log_file.write(f'{self.now.date(), self.now.time()}: ini set param error: {str(Argument)}')
        else:
